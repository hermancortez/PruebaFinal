    ...
    <div>
        <div class="header-dark">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm">
                <div class="container">
                	<a class="navbar-brand" href="#">Registro de Administrativos</a>
...
<div class="contenedor">
            <div class="formulario">
				<form method="post" action="${pageContext.request.contextPath}/administrativocreado" id="formulario">
					<br><br>
                    <div class="en-linea izquierdo">
						<label for="run_adm">RUN :</label>
						<input type="number" id="run_adm" name="run_adm" placeholder="RUN ADMINITRATIVO" required/>
                    </div>
					<br><br>
                    <div class="en linea">
