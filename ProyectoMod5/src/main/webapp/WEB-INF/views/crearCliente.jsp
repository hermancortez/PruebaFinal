...
<div class="contenedor">
            <div class="formulario">
				<form method="post" action="${pageContext.request.contextPath}/clientecreado" id="formulario">
					<br><br>
                    <div class="en-linea izquierdo">
						<label for="run_adm">RUT :</label>
						<input type="number" id="rutcliente" name="rutcliente" placeholder="RUN ADMINITRATIVO" required/>
                    </div>
					<br><br>
                    <div class="en linea">
						<label for="nombres">Nombres:</label>
                        <input type="text" id="clinombre" name="clinombre" placeholder="NOMBRES" required/>
					</div>
                	<div class="campo">
                	<div class="en-linea izquierdo">
						<label for="apellidos">Apellidos:</label>
						<input type="text" id="cliapellido" name="cliapellido" placeholder="APELLIDOS" required/>
				    </div>
                    <br><br>
					<div class="en linea">
						<label for=" direccion"> Telefono:</label>
                        <input type="text" id="clitelefono" name=" clitelefono" placeholder=" DIRECCION" required/>
					</div>
				</div>
				     <div class="en-linea izquierdo">
						<label for="telefono">AFP:</label>
						<input type="number" id="afp" name="afp" placeholder="TELEFONO" required/>
                    </div> 
					 <br><br>
					<div class="en linea">
						<label for=" direccion"> Sistema de Salud:</label>
                        <input type="text" id="clisistemasalud" name=" clisistemasalud" placeholder=" DIRECCION" required/>
					</div>
					<div class="en linea izquierdo">
						<label for=" idcliente"> Direccion:</label>
                        <input type="number" id="clidireccion" name=" clidireccion" placeholder=" IDCLIENTE" required/>
					</div>
					<div class="en linea izquierdo">
						<label for=" idcliente"> Comuna:</label>
                        <input type="number" id="clicomuna" name=" clicomuna" placeholder=" IDCLIENTE" required/>
					</div>
					<div class="en linea izquierdo">
						<label for=" idcliente"> Edad:</label>
                        <input type="number" id="cliedad" name=" cliedad" placeholder=" IDCLIENTE" required/>
					</div>
					<div class="en linea izquierdo">
						<label for=" idcliente"> RUN:</label>
                        <input type="number" id="run_cliente" name=" run_cliente" placeholder=" IDCLIENTE" required/>
					</div>
                <div class="botones">
